...
import LoadMore from "@components/shop-search/elements/LoadMore";
import ShopOptions from "@components/shop-search/elements/ShopOptions";
import ShopFilters from "@components/shop-search/elements/ShopFilters";
import ShopProducts from "@components/shop-search/elements/ShopProducts";
...
const ShopGrid = ({
  ...
  const { filterPanelShow, filterPanelHandler, getFilterParam } =
    useFilter(products);
