      ...
      <div className={dark ? "tt-color-scheme-01" : "tt-header-light"}>
        <Container fluid={containerFluid}>
          <div className="tt-header-holder">
            ...
            >
              {navbar && (
                <Navbar navData={navData} hoverStyleClass="tt-hover-03" />
              )}
            </div>
...
DesktopHeaderAdmin.defaultProps = {
  dark: false,
  navbar: true,
};

export default DesktopHeaderAdmin;
