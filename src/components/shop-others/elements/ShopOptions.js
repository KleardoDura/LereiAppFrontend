  ...
  return (
    ...
    >
      <h1 className="tt-title">
        {pageTitle ? pageTitle : "Të gjithë produktet nga Userat"}{" "}
      </h1>
      ...
      <div className="tt-sort d-none d-lg-flex">
        ...
        <div className="sorting">
          <label className="m-0">RENDIT:</label>
          <SortBy onSortHandler={onSortHandler} />
        </div>
*/}
        <div className="show_per_Page">
          <label className="m-0">SHFAQ:</label>
          <ProductPerPage
      ...
      <div className="tt-quantity">
        ...
        {windowSize > 790 && (
          <button
            className={`tt-col-three tt-show ${
              layout === "tt-col-three" ? "active" : ""
            }`}
